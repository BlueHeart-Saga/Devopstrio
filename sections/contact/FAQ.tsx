          ...
          {faqItems.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`mt-4 text-sm sm:text-base md:text-lg text-zinc-300 leading-relaxed font-semibold max-w-4xl flex flex-col gap-4 ${isOpen ? "block animate-fadeIn" : "hidden"}`}>
                  <p>{item.a}</p>
