        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Reveal className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-rose-500/10 transition-colors">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Agentic AI & Swarms</h4>
          ...
          <Reveal delay={0.05} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-rose-500/10 transition-colors">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">AI Governance & Auditing</h4>
          ...
          <Reveal delay={0.1} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-rose-500/10 transition-colors">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">AI for Cloud Operations</h4>
