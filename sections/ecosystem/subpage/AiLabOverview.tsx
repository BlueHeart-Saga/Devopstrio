        ...
        <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 text-left grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">AI Research</h4>
              ...
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">AI Prototyping</h4>
              ...
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">LLM Engineering</h4>
              ...
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">Agent Development</h4>
              ...
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">AI Product Innovation</h4>
              ...
              <div className="border-l border-rose-500/30 pl-4 py-2">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">AI Transformation</h4>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-sm bg-zinc-950/20 border border-zinc-900 rounded-3xl p-8 relative overflow-hidden text-center">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Devopstrio Cognitive Blueprint</h4>
