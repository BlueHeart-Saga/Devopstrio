          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            <Reveal className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">40%</span>
                <h4 className="text-xs font-bold text-zinc-200">Faster Operations</h4>
              </div>
            </Reveal>

            <Reveal delay={0.03} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">70%</span>
                <h4 className="text-xs font-bold text-zinc-200">Reduced Tasks</h4>
              </div>
            </Reveal>

            <Reveal delay={0.06} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">24/7</span>
                <h4 className="text-xs font-bold text-zinc-200">Intelligent Support</h4>
              </div>
            </Reveal>

            <Reveal delay={0.09} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">92%</span>
                <h4 className="text-xs font-bold text-zinc-200">Accurate Decisions</h4>
              </div>
            </Reveal>

            <Reveal delay={0.12} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">5x</span>
                <h4 className="text-xs font-bold text-zinc-200">Accelerated Innovation</h4>
              </div>
            </Reveal>

            <Reveal delay={0.15} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
                <span className="block text-3xl font-semibold font-mono text-rose-500 mb-1">100%</span>
                <h4 className="text-xs font-bold text-zinc-200">Scalable Automation</h4>
              </div>
            </Reveal>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Reveal className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">AI Customer Support</h4>
            ...
            <Reveal delay={0.05} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Document Processing</h4>
            ...
            <Reveal delay={0.1} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Predictive Maintenance</h4>
            ...
            <Reveal className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Knowledge Management</h4>
            ...
            <Reveal delay={0.05} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Intelligent Monitoring</h4>
            ...
            <Reveal delay={0.1} className="h-full">
              <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-6 hover:border-zinc-800 transition-colors">
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Enterprise Search</h4>
            ...
            {["Financial", "Healthcare", "Retail", "Mfg.", "Telecom", "Logistics", "Public Sec."].map((field, idx) => (
              <Reveal key={idx} delay={idx * 0.03} className="h-full">
                <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/20 transition-all text-center">
                  <span className="block text-base md:text-lg font-semibold text-zinc-200">{field}</span>
                </div>
              </Reveal>
            ))}
          </div>
          ...
          <div className="bg-zinc-950/30 border border-zinc-900 rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6 relative items-center text-center">
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">Enterprise Data</h4>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">AI Data Layer</h4>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">LLM Layer</h4>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">Agent Layer</h4>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">Applications</h4>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-2xl relative z-10 group hover:border-rose-500/20 transition-colors">
                ...
                <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-1">Users</h4>
