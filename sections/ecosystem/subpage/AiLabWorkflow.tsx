        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 relative">
          ...
          <Reveal className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Discover</h4>
          ...
          <Reveal delay={0.05} className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Assess</h4>
          ...
          <Reveal delay={0.1} className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Prototype</h4>
          ...
          <Reveal delay={0.15} className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Validate</h4>
          ...
          <Reveal delay={0.2} className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Deploy</h4>
          ...
          <Reveal delay={0.25} className="h-full z-10">
            <div className="h-full bg-zinc-950/40 border border-zinc-900 rounded-2xl p-5 relative">
              ...
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Optimize</h4>
