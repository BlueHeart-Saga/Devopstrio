        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Reveal className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">AI Knowledge Assistant</h4>
          ...
          <Reveal delay={0.05} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Document Intelligence Engine</h4>
          ...
          <Reveal delay={0.1} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Customer Support Copilot</h4>
          ...
          <Reveal delay={0.15} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Recruitment AI</h4>
          ...
          <Reveal className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Sales Intelligence Platform</h4>
          ...
          <Reveal delay={0.05} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Contract Review Assistant</h4>
          ...
          <Reveal delay={0.1} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">Enterprise Search Engine</h4>
          ...
          <Reveal delay={0.15} className="h-full">
            <div className="h-full bg-zinc-950/20 border border-zinc-900 rounded-2xl p-5 hover:border-rose-500/25 transition-all">
              <h4 className="text-base md:text-lg font-semibold text-zinc-200 mb-2">AI Operations Assistant</h4>
