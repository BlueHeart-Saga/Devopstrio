      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch max-w-5xl mx-auto">
          ...
          <Reveal className="h-full">
            <div className="bg-zinc-950/45 border border-zinc-900 rounded-3xl p-8 flex flex-col justify-between h-full min-h-[320px]">
              <div>
                <div className="flex items-center gap-3 mb-8 border-b border-zinc-900 pb-4">
                  <History className="text-zinc-500 shrink-0" size={20} />
                  <h3 className="text-lg md:text-xl font-semibold text-white uppercase tracking-wider">Traditional Delivery</h3>
                </div>
                ...
                <div className="flex flex-col gap-6 relative pl-6">
                  ...
                  {traditional.map((step) => (
                    <div key={step.label} className="relative">
                      ...
                      <h5 className="text-base md:text-lg font-semibold text-zinc-300 uppercase tracking-wider mb-1">{step.label}</h5>
              ...
              <div className="border-t border-zinc-900 pt-6 mt-8 flex justify-between items-center">
                ...
                <span className="text-sm md:text-base font-semibold text-zinc-500">6–12 Months</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal className="h-full">
            <div className="bg-zinc-950/40 border border-rose-500/10 rounded-3xl p-8 flex flex-col justify-between h-full min-h-[320px] shadow-[0_0_30px_rgba(244,63,94,0.02)]">
              <div>
                <div className="flex items-center justify-between mb-8 border-b border-zinc-900/60 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-white uppercase tracking-wider">Accelerated Delivery</h3>
                  </div>
                ...
                <div className="flex flex-col gap-6 relative pl-6">
                  ...
                  {accelerated.map((step) => (
                    <div key={step.label} className="relative">
                      ...
                      <h5 className="text-base md:text-lg font-semibold text-white uppercase tracking-wider mb-1">{step.label}</h5>
