...
export function AcceleratorsHero() {
  const images = [
    { id: 0, title: "Cloud Infrastructure", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-23.webp" },
    { id: 1, title: "AI Prompt Orchestration", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-24.webp" },
    { id: 2, title: "DevSecOps Automation", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-25-1.webp" },
    { id: 3, title: "Custom SaaS Boilerplate", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-26.webp" },
    { id: 4, title: "Identity Integration", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-27-1.webp" },
    { id: 5, title: "Serverless Blueprints", src: "/webp/assets/ecosystem/herocard/acc-frameworks/Group-28.webp" }
  ];
  ...
  return (
    <section className="relative w-full min-h-[75vh] flex flex-col items-center justify-between bg-black overflow-hidden pt-16 md:pt-20 pb-4 border-b border-zinc-900/60">
      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10 flex flex-col items-center text-center pt-4 md:pt-6">

        {/* Title Header at the Top Side */}
        <Reveal delay={0.1} className="max-w-5xl">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold tracking-tight leading-tight mb-6 text-white text-center">
            Accelerating Innovation Through Reusable Engineering Assets
          </h1>
        </Reveal>

        {/* Feel Good Quote */}
        <Reveal delay={0.2} className="max-w-4xl mb-12">
          <p className="text-zinc-200 text-base md:text-lg lg:text-xl font-semibold italic tracking-wide text-center mx-auto opacity-95 leading-relaxed">
            “Transforming complex cloud architectures into production-ready blueprints — built to fast-track enterprise innovation and engineer lasting competitive advantage.”
          </p>
        </Reveal>
