      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-5xl mx-auto">
          {metrics.map((metric) => (
            <div
              key={metric.label}
              className="bg-zinc-950/40 border border-zinc-900 rounded-3xl p-6 text-center flex flex-col justify-between min-h-[160px] hover:border-rose-500/10 transition-all duration-300"
            >
              <div>
