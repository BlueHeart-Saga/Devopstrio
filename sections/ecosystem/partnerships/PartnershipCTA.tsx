      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10 text-center">
        <Reveal className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-xl md:text-2xl xl:text-3xl font-bold tracking-tight leading-tight mb-5 text-white">
            Build the <span className="text-white font-medium bg-gradient-to-r from-red-600 via-rose-600 to-rose-500 bg-clip-text text-transparent">Future Together</span>
          </h2>

          <p className="text-zinc-400 text-sm md:text-lg leading-relaxed font-bold mb-10 max-w-lg">
            Partner with Devopstrio to deliver cloud, AI, data, and digital transformation solutions at enterprise scale.
          </p>
          ...
          <div className="flex flex-wrap gap-4 justify-center items-center">
            ...
            >
              <Mail size={14} className="text-rose-500 mr-1" /> Talk to Alliance Team
            </Link>
          </div>
