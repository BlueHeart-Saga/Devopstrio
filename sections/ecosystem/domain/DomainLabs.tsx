        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Reveal className="h-full">
            <div className="h-full bg-zinc-950/10 border border-zinc-900 rounded-3xl p-8 hover:border-rose-500/30 hover:bg-zinc-900/5 transition-all duration-300 relative group overflow-hidden">
              ...
              <h3 className="text-base md:text-lg font-semibold text-white mb-3 group-hover:text-rose-455 transition-colors">
              ...
              <div className="border-t border-zinc-900/60 pt-4 flex flex-wrap gap-2">
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">PyTorch</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Llama-3</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">LangGraph</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.05} className="h-full">
            <div className="h-full bg-zinc-950/10 border border-zinc-900 rounded-3xl p-8 hover:border-rose-500/30 hover:bg-zinc-900/5 transition-all duration-300 relative group overflow-hidden">
              ...
              <div className="border-t border-zinc-900/60 pt-4 flex flex-wrap gap-2">
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Vault</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Terraform</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Trivy</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1} className="h-full">
            <div className="h-full bg-zinc-950/10 border border-zinc-900 rounded-3xl p-8 hover:border-rose-500/30 hover:bg-zinc-900/5 transition-all duration-300 relative group overflow-hidden">
              ...
              <h3 className="text-sm font-bold text-white mb-3 group-hover:text-rose-455 transition-colors">
              ...
              <div className="border-t border-zinc-900/60 pt-4 flex flex-wrap gap-2">
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Kubernetes</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Prometheus</span>
                <span className="px-2.5 py-1 rounded bg-zinc-900 text-zinc-405 text-[9px] font-mono border border-zinc-800/80">Jaeger</span>
              </div>
            </div>
          </Reveal>
        </div>
