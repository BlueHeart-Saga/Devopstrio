      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          {metrics.map((metric, idx) => (
            ...
            >
              <div className="text-3xl md:text-4xl font-bold text-rose-500 tracking-tight mb-2">
                {metric.value}
              </div>
              <div className="text-base md:text-lg font-semibold text-white uppercase tracking-widest leading-normal">
                {metric.label}
              </div>
            </div>
          ))}
