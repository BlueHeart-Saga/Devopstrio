...
import { ArrowRight, UserCheck, MessageSquare } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-12 xl:px-8 text-center relative z-10">
        ...
        <Reveal delay={0.1}>
          <h2 className="text-3xl md:text-4xl xl:text-5xl font-black tracking-tight leading-tight mb-6">
            Join the Devopstrio <span className="text-rose-500">Technology Community</span>
          </h2>
        </Reveal>

        <Reveal delay={0.2}>
          <p className="text-zinc-400 text-xs md:text-sm xl:text-base font-semibold leading-relaxed mb-10 max-w-2xl mx-auto">
