...
import { ArrowUpRight, UserCheck, MessageSquare } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10 text-center">
        <Reveal className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-xl md:text-2xl xl:text-3xl font-bold tracking-tight leading-tight mb-8">
            Join the Devopstrio <span className="text-white font-medium bg-gradient-to-r from-red-600 via-rose-600 to-rose-500 bg-clip-text text-transparent">Technology Community</span>
          </h2>

          <p className="text-zinc-400 text-sm md:text-lg leading-relaxed font-bold mb-10 max-w-lg">
            Connect with engineers, innovators, researchers, and technology leaders shaping the future of digital transformation.
          </p>
          ...
          <div className="flex flex-wrap gap-4 justify-center items-center">
            ...
            >
              <UserCheck size={14} className="text-rose-500 mr-1" /> Partner With Us
            </Link>
            <Link
              href="/careers"
              className="gap-2 inline-flex items-center justify-center px-6 py-3.5 rounded-lg text-xs font-bold tracking-wider uppercase border border-zinc-850 hover:border-zinc-750 bg-zinc-950/60 hover:bg-zinc-900 text-white transition-all duration-300 hover:-translate-y-0.5"
            >
              <MessageSquare size={14} className="text-rose-500 mr-1" /> Explore Careers
            </Link>
          </div>
