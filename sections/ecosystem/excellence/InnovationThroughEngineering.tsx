      ...
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programs.map((prog) => (
            <div
              key={prog.title}
              className="bg-zinc-950/40 border border-zinc-900/80 rounded-2xl p-6 hover:border-rose-500/10 transition-all duration-300 min-h-[100px] flex flex-col justify-between"
            >
              <div>
                <h4 className="text-base md:text-lg font-semibold text-white uppercase tracking-wider mb-2">{prog.title}</h4>
