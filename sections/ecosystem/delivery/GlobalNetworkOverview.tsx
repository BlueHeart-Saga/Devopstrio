...
export function GlobalNetworkOverview() {
  ...
  const groups: Record<string, CountryGroup> = {
    uk: {
      ...
      flag: "🇬🇧",
      offices: [
        { name: "London HQ", address: "128 City Road, London, EC1V 2NX", role: "Global Headquarters" },
        { name: "London W1", address: "167-169 Great Portland Street, 5th Floor, W1W 5PF", role: "Client Experience Centre" }
      ]
    },
    us: {
      ...
      flag: "🇺🇸",
      offices: [
        { name: "Tennessee", address: "522 Aventura Dr, Mt Juliet, Tennessee 37122", role: "North America Operations" }
      ]
    },
    in: {
      country: "India",
      flag: "🇮🇳",
      offices: [
        { name: "Bengaluru Engineering Centre", address: "Embassy Golf Links Business Park, Bengaluru", role: "R&D and Software Development" },
        { name: "Chennai Cloud & SecOps Hub", address: "Guindy Industrial Estate, Chennai", role: "Cloud operations & Security" },
        { name: "Thoothukudi DevOps & Automation Center", address: "Rajeev Colony, Pasuvanthanai", role: "CI/CD & platform engineering" }
      ]
    }
  };
              ...
              >
                <div>
                  <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block mb-4 border-b border-zinc-900 pb-2">
                    ACTIVE HUB LOCATIONS ({currentGroup.flag} {currentGroup.country})
                  </span>
                    ...
                    {currentGroup.offices.map((office) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <span className="block text-[8px] font-mono text-rose-500 uppercase tracking-widest mt-0.5 mb-2 font-bold">
                            {office.role}
                          </span>
