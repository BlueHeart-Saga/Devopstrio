...
import { Rocket, Eye, Download, ChevronRight } from "lucide-react";
...
export function PlatformProductsSection({
  ...
  return (
    <section id="platform-products" className="scroll-mt-36">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-white tracking-tight flex items-center gap-2">
            <Rocket className="w-6 h-6 text-rose-500" />
            Proprietary SaaS Platform Datasheets
          </h2>
          <p className="text-sm text-zinc-400 mt-1">Product datasheets, feature breakdowns, and technical specs for Humanex, Homela, CareSuite, Brio, and SafeSign.</p>
        </div>
        <Link href="/marketing/platforms" className="text-xs font-semibold text-rose-500 hover:text-rose-400 flex items-center gap-1">
          All Platforms <ChevronRight className="w-4 h-4" />
        </Link>
      </div>
