...
export function WhitepapersSection({
  ...
  return (
    <section id="whitepapers" className="scroll-mt-36">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">In-depth research reports, Generative AI benchmarks, and security playbooks.</p>
        </div>
        <Link href="/marketing/whitepapers" className="text-xs font-semibold text-rose-500 hover:text-rose-400 flex items-center gap-1">
          All Whitepapers <ChevronRight className="w-4 h-4" />
        </Link>
      </div>
