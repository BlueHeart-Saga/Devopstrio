...
import { Building2, Eye, Download, ChevronRight } from "lucide-react";
...
export function CompanyDocumentsSection({
  ...
  return (
    <section id="company-documents" className="scroll-mt-36">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-white tracking-tight flex items-center gap-2">
            <Building2 className="w-6 h-6 text-rose-500" />
            Company Documents & Decks
          </h2>
          <p className="text-sm text-zinc-400 mt-1">Official corporate profile, pitch presentations, capability statements, and brand guidelines.</p>
        </div>
        <Link href="/marketing/company" className="text-xs font-semibold text-rose-500 hover:text-rose-400 flex items-center gap-1">
          Explore All Corporate <ChevronRight className="w-4 h-4" />
        </Link>
      </div>
