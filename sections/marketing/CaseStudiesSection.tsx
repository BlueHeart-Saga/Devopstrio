...
import { BookOpen, Eye, Download, ChevronRight } from "lucide-react";
...
export function CaseStudiesSection({
  ...
  return (
    <section id="case-studies" className="scroll-mt-36">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Quantified client transformations, AWS/Azure migrations, and AI deployments.</p>
        </div>
        <Link href="/marketing/case-studies" className="text-xs font-semibold text-rose-500 hover:text-rose-400 flex items-center gap-1">
