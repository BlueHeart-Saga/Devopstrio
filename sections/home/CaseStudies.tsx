        ...
        <div className="relative flex flex-col gap-10 lg:pr-6">
          <Reveal>
            ...
            <h2 className="text-4xl md:text-5xl font-light tracking-tight text-white mb-6 leading-[1.1]">
              Technology Investments That Deliver <span className="font-bold">Business Value</span>.
            </h2>
            ...
            {caseStudies.map((study, idx) => (
              <div
                ...
                className={`w-full transition-opacity duration-1000 ${
                  idx === activeIndex ? "opacity-100 z-10 relative" : "opacity-0 z-0 absolute top-0 left-0 pointer-events-none"
                }`}
              >
                ...
                {caseStudies.map((_, i) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-500 ${
                      i === activeIndex ? "w-8 bg-rose-500" : "w-2 bg-zinc-700 hover:bg-zinc-500"
                    }`}
