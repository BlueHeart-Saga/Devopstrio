...
export function Insights() {
  const listInsights: InsightItem[] = [
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1.8fr_1.1fr] gap-8">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 hover:border-zinc-800 hover:bg-zinc-900/10 overflow-hidden group transition-all duration-300 flex flex-col justify-between h-full">
              ...
              <div className="p-6 flex flex-col justify-between flex-1 gap-6">
                <h3 className="text-sm font-bold text-zinc-200 leading-snug group-hover:text-white transition-colors">
          ...
          <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 hover:border-zinc-800 hover:bg-zinc-900/10 overflow-hidden group transition-all duration-300 flex flex-col h-full relative">
            ...
            <div className="p-8 flex flex-col justify-between flex-1 gap-6">
              <div>
                <h3 className="text-xl md:text-2xl font-bold text-white tracking-tight leading-snug mb-3 group-hover:text-rose-100 transition-colors">
                ...
                <p className="text-zinc-400 text-sm md:text-base font-medium leading-relaxed">
                  Driving conversations on AI transformation, cloud innovation, and digital leadership across global enterprise networks.
                </p>
              </div>
              ...
              >
                Watch Now 
                <Play size={10} fill="currentColor" className="transition-transform duration-300 group-hover/btn:scale-110" />
              </a>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 hover:border-zinc-800 transition-all duration-300 p-6 flex flex-col justify-between gap-6">
            ...
            <div className="pt-6 border-t border-zinc-900/60 flex items-center gap-3 text-zinc-500">
              ...
              <span className="text-[10px] uppercase font-bold tracking-wider text-zinc-400">Research Publication Hub</span>
            </div>
          </div>
