...
const services = [
  {
    ...
    image: "/webp/assets/About-page/overview/customersupport/0d35c8aab4c24170e61d1ea01fc4ee77-1.webp",
  },
  {
    id: "devops",
    icon: GitBranch,
    ...
    image: "/webp/assets/About-page/overview/customersupport/1d57a7791a12aaa4fb18f8fa649970bd-1.webp",
  },
  {
    id: "app",
    icon: AppWindow,
    ...
    image: "/webp/assets/About-page/overview/customersupport/99acdd4cc45c729c9eae31b4df03ea1b-1.webp",
  },
  {
    id: "security",
    icon: ShieldCheck,
    ...
    image: "/webp/assets/About-page/overview/customersupport/image-6.webp",
  },
];
...
export const SupportServices = () => {
  ...
  return (
    <section className="py-20 bg-black relative font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
          ...
          <div className="flex flex-row lg:flex-col gap-3 lg:w-[280px] xl:w-80 shrink-0 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0 w-full">
            {services.map((s) => (
              <button
                ...
                className={`flex items-center gap-3.5 px-5 py-4 rounded-xl text-left transition-all duration-300 shrink-0 lg:shrink cursor-pointer
                  ${active === s.id
                    ? "bg-rose-500/10 text-white shadow-[0_0_20px_rgba(244,63,94,0.15)]"
                    : "bg-zinc-950/60 text-zinc-400 hover:text-white"}`}
              >
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-colors
                  ${active === s.id ? "bg-rose-500/20 text-rose-500" : "bg-zinc-900 text-zinc-400"}`}
                >
          ...
          <div className="flex-1 w-full bg-zinc-950/80 rounded-[24px] shadow-2xl overflow-hidden min-h-[260px] lg:min-h-[280px] flex flex-col sm:flex-row">
            ...
            <div className="w-full sm:w-5/12 lg:w-1/2 relative h-56 sm:h-auto overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-zinc-950 hidden sm:block" />
