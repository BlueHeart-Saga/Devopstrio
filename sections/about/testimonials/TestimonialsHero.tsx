...
const avatarColumns: AvatarColumn[] = [
  { hideOn: "lg", items: [{ type: "empty" }, { type: "image", src: "image-164.webp" }, { type: "image", src: "image-165.webp" }] },
  { hideOn: "md", items: [{ type: "image", src: "image-166.webp" }, { type: "image", src: "image-167.webp" }] },
  { hideOn: "none", items: [{ type: "empty" }, { type: "image", src: "image-168.webp" }] },
  { hideOn: "none", items: [{ type: "image", src: "image-169.webp" }] },
  { hideOn: "none", items: [{ type: "empty" }, { type: "image", src: "image-170.webp" }] },
  { hideOn: "none", items: [{ type: "image", src: "image-171.webp" }] },
  { hideOn: "none", items: [{ type: "empty" }, { type: "image", src: "image-172.webp" }] },
  { hideOn: "md", items: [{ type: "image", src: "image-173.webp" }, { type: "image", src: "image-174.webp", tilt: true }] },
  { hideOn: "lg", items: [{ type: "empty" }, { type: "image", src: "image-175.webp" }, { type: "image", src: "image-176.webp" }] },
];
            ...
            >
              {col.items.map((item, j) => {
                ...
                return (
                  ...
                  >
                    <Image 
                      src={`/webp/assets/Home-page/client-reviews/${item.src}`} 
                      alt="Client Portrait" 
                      fill 
