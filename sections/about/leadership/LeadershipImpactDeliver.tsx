...
export const LeadershipImpactDeliver = () => {
  return (
    <section
      ...
      className="py-12 sm:py-16 bg-black text-white relative overflow-hidden font-sans"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 relative z-10 space-y-12 sm:space-y-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-4 sm:mb-6 relative z-10 flex flex-col items-center">
