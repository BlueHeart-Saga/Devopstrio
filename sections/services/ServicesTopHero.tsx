...
export function ServicesTopHero() {
  return (
            ...
            <div className="ml-0 sm:ml-16 md:ml-36 lg:ml-52 max-w-xl">
              <Reveal delay={0.15}>
                <p className="text-zinc-300 text-base sm:text-lg md:text-xl font-normal leading-relaxed mb-8">
                  End-to-end cloud engineering, Generative AI pipelines, DevSecOps automation, and enterprise platform modernization built for scale, resilience, and speed.
                </p>
              </Reveal>
