...
export function ServicesHero() {
  return (
    <section className="relative w-full min-h-[580px] lg:min-h-[640px] flex items-center justify-center bg-[#030303] text-white pt-28 pb-16 lg:pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left justify-center relative z-20">
            ...
            <Reveal delay={0.05}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.15] text-white mb-6 font-sans">
                End-to-End <span className="text-rose-500 font-semibold">Technology Services</span> for Modern Enterprise
              </h1>
            </Reveal>
