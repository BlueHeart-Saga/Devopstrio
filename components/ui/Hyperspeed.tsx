...
const DEFAULT_EFFECT_OPTIONS: Required<Omit<HyperspeedOptions, "distortion">> & { distortion: string } = {
  onSpeedUp: () => {},
  onSlowDown: () => {},
  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      init() {
        ...
        let instanced = new THREE.InstancedBufferGeometry().copy(geometry as any) as any;
