...
export default function FloatingLines({
  ...
  const finalGradient = React.useMemo(() => {
    ...
    const stops = [gradientStart, gradientMid, gradientEnd].filter(Boolean) as string[];
  ...
  useEffect(() => {
    ...
    if (finalGradient && finalGradient.length > 0) {
      const stops = finalGradient.slice(0, MAX_GRADIENT_STOPS);
