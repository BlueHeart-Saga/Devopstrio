...
export function ServicePageLayout({
  ...
  stats,
  capabilities,
  ctaText = "Consult with Our Technical Lead"
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white pt-32 pb-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-rose-600/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <nav className="flex items-center gap-2 text-xs font-mono text-zinc-500 mb-8 overflow-x-auto whitespace-nowrap py-1">
          ...
          <Link href="/services" className="hover:text-rose-500 transition-colors">SERVICES</Link>
          <ChevronRight size={10} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {stats.map((stat, idx) => (
              <div key={idx} className="bg-zinc-950/40 border border-zinc-900 rounded-xl p-5 hover:border-zinc-800 transition-all duration-300">
                <span className="block text-3xl font-black text-white bg-gradient-to-r from-rose-500 to-red-500 bg-clip-text text-transparent mb-1">
                  {stat.value}
                </span>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-850 p-8 md:p-12 bg-zinc-950/80 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight">Looking to accelerate your development timeline?</h2>
          <p className="text-zinc-400 mb-8 max-w-lg mx-auto text-sm leading-relaxed">
            Get in touch with our team to explore tailored consulting and custom execution models tailored for your requirements.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link href="/services" className="inline-flex items-center gap-1.5 px-6 py-3.5 bg-zinc-900 border border-zinc-800 rounded-full font-bold hover:bg-zinc-850 hover:border-zinc-700 transition-all text-xs uppercase tracking-wider text-zinc-300">
