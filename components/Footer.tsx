      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-6 gap-y-12 mb-20">
          ...
          <div className="flex flex-col gap-3">
              <Link href="/" className="flex flex-col items-start gap-3 group inline-flex">
                <img 
              ...
              <div className="p-3 rounded-2xl flex flex-col gap-2 max-w-[240px]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 bg-white hover:bg-zinc-100 text-black py-2 rounded-xl text-[10px] font-bold transition-all duration-300 shadow-sm w-full"
                  >
