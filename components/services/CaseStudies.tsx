      ...
      <div className="max-w-site mx-auto px-6 md:px-12 lg:px-20">
        ...
        <Reveal className="mb-16 text-left">
          ...
          <h2 className="text-2xl md:text-3xl font-light text-white tracking-tight leading-snug">
            Validated project <span className="font-semibold text-rose-500">successes</span>
          </h2>
        </Reveal>
        ...
        <div className="flex flex-col gap-12">
          {caseStudies.map((cs, idx) => (
            <div
              key={idx}
              className="bg-zinc-950/20 border border-zinc-900 rounded-3xl p-8 lg:p-12 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center relative overflow-hidden text-left"
            >
