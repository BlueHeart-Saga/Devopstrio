            ...
            <div className="lg:col-span-6">
              <div className="relative group rounded-3xl border border-zinc-900 bg-zinc-950/40 p-4 hover:border-rose-500/20 transition-colors shadow-2xl">
                <div className="relative aspect-[16/10] overflow-hidden rounded-2xl border border-zinc-900/60">
                  <Image
                    src="/webp/assets/Home-page/our-products/humanex.webp"
      ...
      <section className="relative w-full py-24 bg-black text-white overflow-hidden border-b border-zinc-900/60">
        <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              { icon: Lock, title: "SAML SSO Integrations", desc: "Authenticate employee access using Okta, Azure AD, or corporate catalogs.", image: "/webp/assets/common/09ff7846bc8c9998745688779c09f88d-1.webp" },
              { icon: Upload, title: "Secure Upload Portals", desc: "Upload employee contracts, scans, and IDs with automatic isolation checkups.", image: "/webp/assets/common/1b065043b6959827c05a0073c93a4a53-1.webp" },
              { icon: ShieldCheck, title: "Granular Role Settings (RBAC)", desc: "Enforce strict boundaries between managers, payroll admins, and employees.", image: "/webp/assets/common/260b761ad40c3ad2acba2c6666894539-1.webp" },
              { icon: Activity, title: "Encrypted Audit Records", desc: "Every profile review, salary adjustment, or document check is logged.", image: "/webp/assets/common/2fe7f9184c515b0c515ce38bc8a25efa-1.webp" }
            ].map((sec, idx) => (
