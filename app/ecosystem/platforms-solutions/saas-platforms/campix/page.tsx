          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center text-left">
              ...
              <Reveal delay={0.1}>
                ...
                <p className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-455 mb-6">
            ...
            <div className="lg:col-span-6">
              <div className="relative group rounded-3xl border border-zinc-900 bg-zinc-950/40 p-4 hover:border-purple-500/20 transition-colors shadow-2xl">
                <div className="relative aspect-[16/10] overflow-hidden rounded-2xl border border-zinc-900/60">
                  <Image
                    src="/webp/assets/Home-page/our-products/campix.webp"
      ...
      <section className="relative w-full py-24 bg-black text-white overflow-hidden border-b border-zinc-900/60">
        <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              { icon: Lock, title: "Multi-Factor Authentication", desc: "Protect client profiles and ad account budgets with secure MFA checkups.", image: "/webp/assets/common/09ff7846bc8c9998745688779c09f88d-1.webp" },
              { icon: Upload, title: "Secure Data Uploads", desc: "Upload ad creative files and invoice PDFs securely with isolation checks.", image: "/webp/assets/common/1b065043b6959827c05a0073c93a4a53-1.webp" },
              { icon: ShieldCheck, title: "Role Permission Controls", desc: "Limit dashboard coordinates to specific team roles or clients.", image: "/webp/assets/common/260b761ad40c3ad2acba2c6666894539-1.webp" },
              { icon: Activity, title: "Encrypted Audit Records", desc: "Every budget update, integration link, or report check is logged.", image: "/webp/assets/common/2fe7f9184c515b0c515ce38bc8a25efa-1.webp" }
            ].map((sec, idx) => (
