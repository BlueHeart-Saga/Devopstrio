  ...
  return (
    <main className="min-h-screen bg-black text-white pt-16 font-sans overflow-x-hidden selection:bg-rose-500 selection:text-white">
      ...
      <Hero
        ...
        subtitle="Accelerating enterprise transformation through cloud-native architectures, platform engineering templates, GPU computing infrastructure, and multi-cloud innovation."
