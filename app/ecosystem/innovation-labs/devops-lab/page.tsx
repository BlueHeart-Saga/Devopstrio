  ...
  return (
    <main className="min-h-screen bg-black text-white pt-16 font-sans overflow-x-hidden selection:bg-rose-500 selection:text-white">
      ...
      <Hero
        ...
        subtitle="Accelerating software delivery through developer platforms, cloud automation, GitOps workflows, observability pipelines, and intelligent site reliability operations."
