...
export default function MicrosoftAllianceHub() {
              ...
              <div className="lg:col-span-5 flex flex-col items-start text-left sticky top-28">
                <Reveal>
                  ...
                  <p className="text-zinc-400 text-sm font-semibold max-w-sm">
                    Find answers to common questions about our custom Microsoft Azure implementation and consulting models.
                  </p>
                </Reveal>
              </div>
  ...
  return (
                      ...
                      >
                        ...
                        >
                          <p className="p-6 text-xs md:text-sm text-zinc-450 leading-relaxed font-semibold">
                            {faq.a}
                          </p>
                        </div>
                      </div>
