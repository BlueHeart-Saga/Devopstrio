            ...
            <div className="lg:col-span-5">
              <Reveal className="text-left sticky top-28">
                ...
                <p className="text-zinc-400 text-xs md:text-sm font-bold max-w-md">
                  Everything you need to know about our Cisco network implementations, security deployments, and managed operations.
                </p>
              </Reveal>
            </div>
              ...
              <div className="flex flex-col gap-4 select-none">
                {faqs.map((faq, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-zinc-950/50 border border-zinc-900 hover:border-sky-500/10 rounded-2xl overflow-hidden transition-all duration-300"
                    >
                      <button
