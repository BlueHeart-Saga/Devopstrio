    ...
    <main className="relative min-h-screen bg-[#030303] text-white font-sans overflow-x-hidden selection:bg-rose-600 selection:text-white">
      ...
      <section className="py-24 bg-[#030303] border-b border-zinc-900/80">
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { name: "Cloud Engineering Lab", img: "/webp/assets/common/464d8932bca4d6bb552ff2dcf2f3c5ca-1.webp", focus: "Azure & AWS Landing Zones" },
              { name: "GenAI & LLM Lab", img: "/webp/assets/common/9d91b93f83e6d4cd494ec13611b3e50e-1.webp", focus: "Vector DBs & Multi-Agents" },
              { name: "DevOps & K8s Sandbox", img: "/webp/assets/common/1b065043b6959827c05a0073c93a4a53-1.webp", focus: "ArgoCD & GitOps Workflows" },
              { name: "Cybersecurity Perimeter Lab", img: "/webp/assets/common/f317dd71184f5c47d601eeb9508bf92c-1.webp", focus: "Zero Trust & eBPF Networks" },
              { name: "IoT & Edge Computing Lab", img: "/webp/assets/common/45ea830d170d382ade235db479060da7-1.webp", focus: "Edge Data Processing" }
            ].map((lab, idx) => (
      ...
      <section className="py-24 bg-[#030303] border-b border-zinc-900/80">
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Software Architects", exp: "12+ Years Experience", expertise: "Microservices & Distributed Systems", img: "/webp/assets/common/1b065043b6959827c05a0073c93a4a53-1.webp" },
              { name: "Cloud Practice Leads", exp: "15+ Years Experience", expertise: "Azure CAF & AWS Control Tower", img: "/webp/assets/common/37b9b888cc479ea7b74d2d9a05c37597-1.webp" },
              { name: "AI Research Specialists", exp: "10+ Years Experience", expertise: "LLM RAG & Autonomous Agents", img: "/webp/assets/common/9d91b93f83e6d4cd494ec13611b3e50e-1.webp" },
              { name: "DevOps & SRE Leads", exp: "14+ Years Experience", expertise: "Kubernetes & GitOps Pipelines", img: "/webp/assets/common/f317dd71184f5c47d601eeb9508bf92c-1.webp" },
              { name: "Cybersecurity Directors", exp: "16+ Years Experience", expertise: "Zero Trust Architecture & Vault", img: "/webp/assets/common/782e79a0bc5e9f58cb9af6a27727ca7b-1.webp" },
              { name: "Data Engineering Leads", exp: "11+ Years Experience", expertise: "Kafka Streaming & Snowflake", img: "/webp/assets/common/82090d7be4ef5694954ce77f9cc2e627-1.webp" }
            ].map((mentor, idx) => (
              <Reveal key={idx} delay={idx * 0.05}>
