  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">AWS Partnership</h1>
        <p className="text-xl text-zinc-400 font-light leading-relaxed mb-12">
          Certified AWS architects delivering secure, scalable, and highly available cloud infrastructure. Detailed case studies coming soon.
        </p>
        ...
        <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-zinc-400 mb-8 max-w-lg mx-auto">
            Get in touch with our experts to discuss how we can leverage AWS for your enterprise.
          </p>
