...
export default function CybersecurityPage() {
  ...
  const heroMetrics = [
    { value: "Zero Trust", label: "Access Security" },
    { value: "eBPF", label: "Cilium Microsegmentation" },
    { value: "SSO / Entra", label: "Identity Platforms" },
    { value: "CSPM / SOC", label: "Compliance Audits" }
  ];
        ...
        <div className="max-w-7xl mx-auto w-full px-12 xl:px-8 relative z-10">
          <Reveal className="max-w-3xl mb-16">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed font-bold">
              Everything you need to know about our Cilium network policies, SSO/Entra ID integrations, and SOC compliance reporting. Can&apos;t find what you&apos;re looking for? Reach out to our team — we respond to every question personally.
            </p>
          </Reveal>
