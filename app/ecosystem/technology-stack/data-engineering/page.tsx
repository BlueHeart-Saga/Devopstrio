...
const DataCapabilities = () => {
  const capabilities = [
    { title: "Data Integration", tag: "Connect", desc: "Connect enterprise systems, APIs, cloud apps, and databases.", image: "/webp/assets/common/1b065043b6959827c05a0073c93a4a53-1.webp" },
    { title: "ETL / ELT Pipelines", desc: "Reliable and automated data movement.", tag: "Move", image: "/webp/assets/common/260b761ad40c3ad2acba2c6666894539-1.webp" },
    { title: "Data Warehousing", tag: "Centralize", desc: "Build centralized analytics-ready repositories.", image: "/webp/assets/common/315e4fdc6263bfd240f36297e376576e-1.webp" },
    { title: "Data Lake Engineering", tag: "Store", desc: "Store structured and unstructured enterprise data.", image: "/webp/assets/common/37b9b888cc479ea7b74d2d9a05c37597-1.webp" },
    { title: "Real-Time Data Streaming", tag: "Process", desc: "Capture and process live events.", image: "/webp/assets/common/464d8932bca4d6bb552ff2dcf2f3c5ca-1.webp" },
    { title: "Data Transformation", tag: "Enrich", desc: "Clean, enrich, and standardize data.", image: "/webp/assets/common/782e79a0bc5e9f58cb9af6a27727ca7b-1.webp" },
    { title: "Master Data Management", tag: "Govern", desc: "Create trusted enterprise-wide data consistency.", image: "/webp/assets/common/82090d7be4ef5694954ce77f9cc2e627-1.webp" },
    { title: "Metadata & Cataloging", tag: "Discover", desc: "Improve discoverability and governance.", image: "/webp/assets/common/90361fed0bb781d7c86e451995b4dbce-1.webp" }
  ];
...
const IndustryUseCases = () => {
  const useCases = [
    { title: "Banking", tag: "Finance", desc: "Transaction analytics and fraud data pipelines.", image: "/webp/assets/common/945ab601f043c558e0a8162da2a1eb4c-1.webp" },
    { title: "Healthcare", tag: "Health", desc: "Clinical data integration and reporting.", image: "/webp/assets/common/9d91b93f83e6d4cd494ec13611b3e50e-1.webp" },
    { title: "Retail", tag: "Commerce", desc: "Customer analytics and demand forecasting.", image: "/webp/assets/common/b384eb0438c55e43c61e7595acc29638-1.webp" },
    { title: "Manufacturing", tag: "Industrial", desc: "Production analytics and IoT integration.", image: "/webp/assets/common/e76e125035885aab9c9070ce85df239e-1.webp" },
    { title: "Telecommunications", tag: "Networking", desc: "Network telemetry and performance analytics.", image: "/webp/assets/common/f03cc521fb070dfae9d87768b791ff70-1.webp" },
    { title: "Government", tag: "Public", desc: "Citizen data platforms and reporting.", image: "/webp/assets/common/f317dd71184f5c47d601eeb9508bf92c-1.webp" },
    { title: "Education", tag: "Learning", desc: "Student analytics and institutional reporting.", image: "/webp/assets/common/45ea830d170d382ade235db479060da7-1.webp" },
    { title: "Logistics", tag: "Supply Chain", desc: "Fleet tracking and supply chain visibility.", image: "/webp/assets/common/2fe7f9184c515b0c515ce38bc8a25efa-1.webp" }
  ];
