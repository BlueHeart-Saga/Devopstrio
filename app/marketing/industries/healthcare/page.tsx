...
export function generateMetadata(): Metadata {
  const seo = getMetadataFromPath("/marketing/industries/healthcare");
  return generatePageMetadata({
    title: seo.title,
    description: seo.description,
    path: "/marketing/industries/healthcare",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Healthcare", url: "https://devopstrio.co.uk/marketing/industries/healthcare" }
        ]}
      />
