...
export function generateMetadata(): Metadata {
  const seo = getMetadataFromPath("/marketing/services/ai-data-innovation");
  return generatePageMetadata({
    title: seo.title,
    description: seo.description,
    path: "/marketing/services/ai-data-innovation",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "AI & Data Innovation", url: "https://devopstrio.co.uk/marketing/services/ai-data-innovation" }
        ]}
      />
          ...
          <div className="p-8 rounded-3xl bg-neutral-900 border border-neutral-800 space-y-6">
            <div className="flex items-center justify-between">
              <span className="px-3 py-1 text-xs font-bold bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-full">
                Practice Brochure • 12.4 MB
              </span>
              <span className="text-xs text-neutral-400">AI & Data Practice</span>
            </div>

            <h1 className="text-3xl sm:text-4xl font-bold text-white">AI & Data Innovation Capabilities</h1>

            <p className="text-neutral-300 text-sm leading-relaxed">
              Enterprise solution sheet outlining Devopstrio&apos;s AI & Data Innovation practice. Details production LLM fine-tuning, retrieval-augmented generation (RAG), vector database engineering, agentic workflow automation, and MLOps pipelines.
            </p>
            ...
            <div className="space-y-3 pt-4 border-t border-neutral-800">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-neutral-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> Custom LLM Fine-Tuning & Quantization</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> Enterprise RAG Architecture (Pinecone/Milvus)</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> Autonomous Multi-Agent Workflows</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> End-to-End MLOps & Model Monitoring</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> Real-Time Analytics & BI Dashboards</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-rose-400" /> Data Governance & Anonymization Pipelines</li>
              </ul>
            </div>
            ...
            <div className="pt-6 border-t border-neutral-800 flex items-center gap-4">
              <button className="px-6 py-3.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-bold text-sm flex items-center gap-2 transition-colors">
                <Download className="w-4 h-4" /> Download PDF (12.4 MB)
              </button>
