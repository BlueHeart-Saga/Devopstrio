...
export function generateMetadata(): Metadata {
  const seo = getMetadataFromPath("/marketing/company/brand-guidelines");
  return generatePageMetadata({
    title: seo.title,
    description: seo.description,
    path: "/marketing/company/brand-guidelines",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Brand Guidelines", url: "https://devopstrio.co.uk/marketing/company/brand-guidelines" }
        ]}
      />
      <div className="min-h-screen bg-[#050505] text-white pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-8">
          ...
          <div className="p-8 rounded-3xl bg-neutral-900 border border-neutral-800 space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white">Devopstrio Brand Guidelines & Identity Kit</h1>
