...
export function generateMetadata(): Metadata {
  const seo = getMetadataFromPath("/marketing/company/corporate-presentation");
  return generatePageMetadata({
    title: seo.title,
    description: seo.description,
    path: "/marketing/company/corporate-presentation",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Corporate Presentation", url: "https://devopstrio.co.uk/marketing/company/corporate-presentation" }
        ]}
      />
