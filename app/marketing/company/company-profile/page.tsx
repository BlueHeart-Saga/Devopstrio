...
import { Download, ArrowLeft, CheckCircle2, Shield } from "lucide-react";
import { generatePageMetadata, getMetadataFromPath } from "@/lib/seo-utils";
import { BreadcrumbSchema } from "@/components/seo/Schemas";

export function generateMetadata(): Metadata {
  const seo = getMetadataFromPath("/marketing/company/company-profile");
  return generatePageMetadata({
    title: seo.title,
    description: seo.description,
    path: "/marketing/company/company-profile",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Company Profile", url: "https://devopstrio.co.uk/marketing/company/company-profile" }
        ]}
      />
