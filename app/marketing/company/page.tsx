...
import { Building2, Download, Eye, ChevronRight, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#050505] text-white pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-10">
        ...
        <div>
          ...
          <h1 className="text-4xl font-extrabold text-white">Company Decks & Brand Guidelines</h1>
