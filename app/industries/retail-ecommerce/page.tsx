...
const data = {
  ...
  overview: {
    ...
    desc1: "We build custom headless storefronts, scalable cart runtimes, and real-time recommendation engines. Our setups process hundreds of catalog operations per second with Redis cache buffers.",
    desc2: "Our services connect online shopping portals with ERP databases, facilitating real-time stock counts, multi-currency pricing layers, and robust payment routing hooks."
  },
  challenges: [
    {
      title: "Cart Concurrency Lockouts",
      desc: "Avoiding transaction database locks when thousands of users attempt to purchase limited-stock items simultaneously."
    },
    {
      title: "Peak Sales Volume Scalability",
      desc: "Preventing website crashes and slow checkouts during major promotional events like Black Friday."
    },
    {
      title: "Omni-Channel Stock Sync Latency",
      desc: "Synchronizing physical store stock levels with online catalog counts immediately to prevent double-selling."
    }
  ],
  solutions: [
    {
      title: "Redis-Buffered Checkouts",
      desc: "Writing reservations to in-memory Redis buffers, letting the database receive clean, throttled writes."
    },
    {
      title: "Autoscaling Headless Nodes",
      desc: "Deploying frontend storefronts via serverless Vercel edges and autoscaling microservice containers."
    },
    {
      title: "GraphQL Catalog Gateways",
      desc: "Consolidating inventory counts, details, and pricing into a unified, lightweight GraphQL endpoint."
    }
  ],
  capabilities: [
    {
  ...
  useCases: [
    {
      ...
      result: "Sustained a 3.5x holiday rush volume spike with 100% checkout completion rates."
    },
    {
      title: "Catalog Speed Up",
      result: "Reduced average cart addition latency down to under 80ms globally."
    }
  ],
  techs: [
    {
  ...
  outcomes: [
    {
      value: "<80ms",
      label: "Cart Latency",
      desc: "Fast item addition speed."
    },
    {
      value: "99.99%",
      label: "Promo Event Uptime",
      desc: "Target reliability during holiday flash sales."
    },
    {
      value: "4.2x",
      label: "Conversion Boost",
      desc: "Purchaser ratios compared to legacy setups."
    }
  ],
  caseStudy: {
    title: "Rebuilding the storefront architecture for global apparel brand.",
    desc: "We re-engineered a legacy e-commerce platform into a headless React application powered by Next.js and Redis. The setup easily sustained a 3x traffic spike during holiday sales, with cart load times dropping to under 80ms.",
    metrics: [
  ...
  compliance: [
    {
      ...
      desc: "Enforcing encrypted card data transport routes, checkout tokens, and secure webhook verifications."
    },
    {
      title: "GDPR & CCPA Safeguards",
      desc: "Integrating customer consent registries and supporting automated account deletion triggers."
    }
  ],
  whyChoose: [
    {
      title: "Flash Sale Proofing",
      desc: "Our architectures handle intense seasonal volume peaks without database locks."
    },
    {
      title: "Conversion-Focused UI",
      desc: "We build headless, lightning-fast pages optimized to keep visitors moving toward checkout."
    },
    {
      title: "Flexible Integrations",
      desc: "Easily link modern frontends with Contentful, Shopify Plus, or private ERP platforms."
    }
  ],
  relatedServices: [
